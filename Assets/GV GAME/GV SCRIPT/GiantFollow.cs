...
public class GiantFollow : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        GameObject[] targetObjects = GameObject.FindGameObjectsWithTag("ZombieGiant"); // Replace "YourTag" with the tag you're looking for
    ...
    private void Update()
    {
        if (player != null)
        {
            ...
            else
            {
                ...
                //
                ///////////////////////////////////////////////////////////////////
                GameObject[] targetObjects = GameObject.FindGameObjectsWithTag("ZombieGiant");
